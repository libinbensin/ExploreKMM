package com.libapps.spacexapp.android
...
class LaunchesRvAdapter(var launches: List<RocketLaunch>) :
    ...
    inner class LaunchViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bindData(launch: RocketLaunch) = launch.run {
            itemView.findViewById<TextView>(R.id.missionName).text = missionName
            itemView.findViewById<TextView>(R.id.launchSuccess).text = launchSuccess.toString()
            itemView.findViewById<TextView>(R.id.launchYear).text = launchYear.toString()
            itemView.findViewById<TextView>(R.id.details).text = details
        }
    }
}